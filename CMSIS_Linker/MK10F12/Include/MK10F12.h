...
**
**     Reference manual:    K10P144M120SF3RM, Rev. 2, Dec 2011
**     Version:             rev. 1.6, 2013-06-24
**
**     Abstract:
**         CMSIS Peripheral Access Layer for MK10F12
**
...
**         Registers of the following modules have been updated - AXBS, CAN, I2S, MCG, MPU, NFC, RCM, RTC, SIM, WDOG
...
**         EWM - INTEN bit group in EWM_CTRL register has been added.
**         PDB - register PDB_PO0EN renamed to PRB_POEN.
**         PMC - BGEN bit group in PMC_REGSC register has been removed.
**         SIM - several changes in SCGC registers.
**         UART - new bit group RXOFE in regiter CFIFO and RXOF in register SFIFO.
**     - rev. 1.3 (2012-04-13)
 ...
 * @version 1.6
 * @date 2013-06-24
 * @brief CMSIS Peripheral Access Layer for MK10F12
 *
 * CMSIS Peripheral Access Layer for MK10F12
 */

#if !defined(MK10F12_H_)
#define MK10F12_H_                               /**< Symbol preventing repeated inclusion */
...
#include "system_MK10F12.h"            /* Device specific configuration file */
